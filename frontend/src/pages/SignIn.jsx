...
// Food image (static asset or CDN preferred for performance)
const FOOD_IMAGE_URL = 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=600&q=80';

function SignIn() {
    const primaryColor = "#ff4d2d";
    const bgGradient = "linear-gradient(135deg, #ff4d2d 0%, #ff7e50 100%)";
    ...
    // Memoized async handler: optimal for reactivity
